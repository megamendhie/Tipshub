...
public class PplAdapter extends FirestoreRecyclerAdapter<ProfileShort, PplAdapter.PostHolder>{
    ...
    public PplAdapter(Query query, String userID, Activity activity, Context context) {
        /*
    ...
    protected void onBindViewHolder(@NonNull PostHolder holder, final int position, @NonNull final ProfileShort model) {
        ...
        //holder.mAccuracy.setText(String.format("||  Accuracy: %"));
    }
